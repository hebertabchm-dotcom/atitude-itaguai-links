      ...
      <div className="max-w-6xl mx-auto flex flex-col items-center">
        ...
        >
          ...
          <div className="relative">
            ...
            <img 
              ...
              className="max-w-[280px] sm:max-w-[400px] md:max-w-lg w-full mx-auto drop-shadow-[0_20px_50px_rgba(249,115,22,0.4)] animate-float"
            />
          </div>
        ...
        <div className="space-y-8">
          ...
          >
            <a 
              href="#cursos" 
              className="group relative bg-white text-zinc-950 px-12 py-5 rounded-2xl font-black text-xs uppercase tracking-widest hover:shadow-[0_0_40px_rgba(255,255,255,0.2)] transition-all overflow-hidden"
            >
            ...
            <a 
              ...
              target="_blank"
              className="px-12 py-5 rounded-2xl border-2 border-white/10 font-black text-xs uppercase tracking-widest text-white hover:bg-white/5 hover:border-white/20 transition-all active:scale-95"
            >
