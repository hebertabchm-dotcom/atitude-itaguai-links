    ...
    <section id="vida-vitoriosa" className="py-24 md:py-32 px-6 bg-zinc-900 border-y border-white/5 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl md:text-7xl font-black mb-8 leading-tight tracking-tight px-4 text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          >
            <div className="p-11 flex flex-col h-full">
              ...
              <h3 className="text-4xl font-black mb-6 tracking-tight text-white">Cadastre-se como Equipe</h3>
              ...
              <Button 
                label="Vou servir na Equipe" 
                href="https://docs.google.com/forms/d/e/1FAIpQLScwOwFZfljE2549VWLvegT39bTRAP1gNygsEjE6wvuaAL9hgw/viewform" 
                variant="orange"
                className="w-full border-2 border-orange-500 bg-transparent text-orange-500 hover:text-white"
              />
            </div>
          </motion.div>
        </div>
